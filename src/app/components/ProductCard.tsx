...
const ProductCard = ()=> {
  return (
<a href="#" className="group m-2 rounded-sm relative block overflow-hidden">
  <button
  ...
  <div className="relative border border-gray-100 bg-white p-6">
    ...
    <form className="mt-4 flex flex-row gap-2 w-full">
      <button
        className="block w-full rounded-sm bg-yellow-400 p-4 text-sm  transition hover:scale-105"
      >
        Add to Cart
      </button>
      <button
